...
function AppointmentNewCard({link_path}) {
    return (
        <Link to={link_path} style={{ textDecoration: 'none', color: 'inherit' }} >
            <div className="min-w-md m-6 md:mb-0 col-span-12 sm:col-span-6 lg:col-span-4 border p-4 rounded-lg shadow-lg flex gap-4">
                ...
                <div className="flex flex-col items-center justify-center">
                    <p className="font-mono text-xl font-normal opacity-75 text-black mb-2">Add new appointment</p>
                </div>
            </div>
        </Link>
    );
...
export default AppointmentNewCard;
