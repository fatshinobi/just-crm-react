...
function PersonCard({ record }) {
    const avatar_url = record.avatar_url ? record.avatar_url : process.env.PUBLIC_URL + "/def_person_ava.png";
    return (
        <div className="min-w-md m-6 md:mb-0 col-span-12 sm:col-span-6 lg:col-span-4 border p-4 rounded-lg shadow-lg flex gap-4">
            ...
            <div className="flex flex-col">
                ...
                <p className="font-mono text-xs font-normal opacity-75 text-black mb-2">{record.role}</p>
            </div>
        </div>
    );
}
