...
function OpportunityCreate() {
    ...
    let defaultValidationErrors = {
        ...
        "stage": "Stage must be selected",
        "status": "Status must be selected",
        "start": "Start date must be present",
    ...
    const fieldValidate = (record, value) => {
        ...
        } else if ((record === "description") && ((value === null) || (value.trim() === ""))) {
            setFormErrors(prev => ({ ...prev, [record]: "Description must be present" }));
    ...
    return (
        <div className="p-4">
            <h1 className="text-3xl font-bold mb-6">Opportunity Create</h1>
